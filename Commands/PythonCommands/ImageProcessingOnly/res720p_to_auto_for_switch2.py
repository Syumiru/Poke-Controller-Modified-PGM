...
class res720p_to_auto_for_switch2(PythonCommand):
    NAME = '720p→自動(高速解像度変更) For Switch2 ver.1.0.0'
    ...
    def do(self):
        print("-------------------------------------")
        print("720p→自動(高速解像度変更) For Switch2 ver.1.0.0")
        ...
        self.res720p_to_auto_for_switch2()
    ...
    def res720p_to_auto_for_switch2(self):
